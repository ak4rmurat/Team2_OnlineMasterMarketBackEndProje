...
public class DB_US006 {
    ...
    @Given("bank_account tablosuna status degeri active, inactive ve pending olan rastgele {int} data eklenir")
    public void bank_account_tablosuna_status_degeri_active_inactive_ve_pending_olan_rastgele_data_eklenir(Integer int1) {
